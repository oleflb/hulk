...
const TEST_CONFIG: TrajectoryTestConfig = TrajectoryTestConfig {
    ...
    measurement_selection: MeasurementSelection::ImuOnly,
    visual_outliers: None,
    solve_every_nth_frame: 1,
    optimizer_max_iterations: 1,
    output_path: "/tmp/graph_trajectory_imu_only.json",
    gyro_noise_std: 0.1,
    accel_noise_std: 0.1,
...
#[test]
fn trajectory_json_imu_only_position_rmse_is_bounded() -> Result<(), Box<dyn Error>> {
